...
We restrict to runs done with manual filtering. `louvain` and `leiden` denote
average seconds per clustering invocation during the resolution search; other
stages remain total stage runtime.
